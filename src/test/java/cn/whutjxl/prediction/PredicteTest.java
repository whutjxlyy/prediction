...
//		classiferName = "weka.classifiers.lazy.LWL";			//50.24
		 ...
		 * 	functions
		 */
//		classiferName = "weka.classifiers.functions.LibLINEAR";				//
//		classiferName = "weka.classifiers.functions.LibSVM";					//
...
//		classiferName = "weka.classifiers.bayes.WAODE";						//62.92
		...
		for (int i = 7; i < 8; i++) {
			Utils.getArffByExcel("src/main/resources/stock.xlsx", "src/main/resources/stock.arff", i, 0);
